export enum AccountEventType {
  OrganizationCreatedV1 = "OrganizationCreatedV1",
  OrganizationActivationToggledV1 = "OrganizationActivationToggledV1",
  OrganizationActivationToggledV2 = "OrganizationActivationToggledV2",
